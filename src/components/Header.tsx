      ...
      <div className="container mx-auto">
        <div className="flex h-16 items-center justify-between">
          ...
          <form
            ...
            className="hidden md:flex items-center border border-slate-300 rounded-md overflow-hidden"
          >
            <input
              type="text"
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              ...
              >
                ...
                <div
                  className={`absolute right-0 mt-2 w-48 bg-white shadow-lg rounded-md py-2 z-50 transition-opacity duration-200 ${
                    isDropdownOpen
                      ? 'opacity-100 visible'
                      : 'opacity-0 invisible'
                  }`}
      ...
      {isMenuOpen && (
        <div className="md:hidden bg-white shadow-lg">
          <div className="container mx-auto py-4">
            ...
            <form
              onSubmit={handleSearch}
              className="mb-4 flex items-center border border-slate-300 rounded-md overflow-hidden"
            >
              <input
                type="text"
                placeholder="Search products..."
